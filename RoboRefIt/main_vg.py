...
from datasets import build_refer_dataset, build_roborefit
...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='outputs/roborefit3',
...
def main(args):
    ...
    dataset_train = build_roborefit('train', args)
    dataset_val = build_roborefit(args.test_split, args)
